...
# Spam
Spam_data = pd.read_csv('../without CL/Spam_Embedding_by_Model_without_CL.csv')
# News
News_data = pd.read_csv('../without CL/News_Embedding_by_Model_without_CL.csv')
# Malicious
Malicious_data = pd.read_csv('../without CL/Malicious_Phish_Embedding_by_Model_without_CL.csv')
# Classification
Classification_data = pd.read_csv('../without CL/Classification_Embedding_by_Model_without_CL.csv')
# App
App_data = pd.read_csv('../without CL/App_Embedding_by_Model_without_CL.csv')
...
accuracies, Log_losses, precisions, f1s, recalls = [], [], [], [], []
...
for data in dataset:
    ...
    print(f'Precision: {precision}, Recall: {recall}, F1 Score: {f1}, Test Accuracy: {accuracy}')
