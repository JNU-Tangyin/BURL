...
# Spam
Spam_data = pd.read_csv('../Semantic Only/Spam_Embedding_by_Semantic_Only.csv')
# News
News_data = pd.read_csv('../Semantic Only/News_Embedding_by_Semantic_Only.csv')
# Malicious
Malicious_data = pd.read_csv('../Semantic Only/Malicious_Phish_Embedding_by_Semantic_Only.csv')
# Classification
Classification_data = pd.read_csv('../Semantic Only/Classification_Embedding_by_Semantic_Only.csv')
# App
App_data = pd.read_csv('../Semantic Only/App_Embedding_by_Semantic_Only.csv')
