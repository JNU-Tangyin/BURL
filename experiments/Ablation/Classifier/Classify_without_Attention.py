...
# Spam
Spam_data = pd.read_csv('../without Attention/Spam_Embedding_by_Model_withoutAttention.csv')
# News
News_data = pd.read_csv('../without Attention/News_Embedding_by_Model_withoutAttention.csv')
# Malicious
Malicious_data = pd.read_csv('../without Attention/Malicious_Phish_Embedding_by_Model_withoutAttention.csv')
# Classification
Classification_data = pd.read_csv('../without Attention/Classification_Embedding_by_Model_withoutAttention.csv')
# App
App_data = pd.read_csv('../without Attention/App_Embedding_by_Model_withoutAttention.csv')
