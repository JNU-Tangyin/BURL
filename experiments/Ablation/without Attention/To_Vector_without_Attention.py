...
# Loading Model
BURL_without_Attention = load_model('../../../Save_Model/BURL_without_Attention.h5')
...
encoder = Model(BURL_without_Attention.input, BURL_without_Attention.layers[-3].output)
...
pd.DataFrame(App_Embedding_by_SentenceBert).to_csv('Spam_Embedding_by_Model_withoutAttention.csv', index=False)
...
pd.DataFrame(News_Embedding_by_SentenceBert).to_csv('News_Embedding_by_Model_withoutAttention.csv', index=False)
...
embeddings_App_url = np.array(compressed_representation)[:, 0, :]
App_Embedding_by_SentenceBert = np.hstack((embeddings_App_url, y_resampled.reshape([-1,1])))
pd.DataFrame(App_Embedding_by_SentenceBert).to_csv('Malicious_Phish_Embedding_by_Model_withoutAttention.csv', index=False)
...
embeddings_App_url = np.array(compressed_representation)[:, 0, :]
App_Embedding_by_SentenceBert = np.hstack((embeddings_App_url, y_resampled.reshape([-1,1])))
pd.DataFrame(App_Embedding_by_SentenceBert).to_csv('Classification_Embedding_by_Model_withoutAttention.csv', index=False)
...
pd.DataFrame(App_Embedding_by_SentenceBert).to_csv('App_Embedding_by_Model_withoutAttention.csv', index=False)
